package com.natashasapplication.app.modules.iphone14seventyfive.`data`.model

import com.natashasapplication.app.R
import com.natashasapplication.app.appcomponents.di.MyApp
import kotlin.String

data class Iphone14SeventyfiveModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup1010: String? = MyApp.getInstance().resources.getString(R.string.lbl_customize)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup1009: String? = MyApp.getInstance().resources.getString(R.string.lbl_customize)
