package com.natashasapplication.app.modules.iphone14seventyeight.`data`.model

import com.natashasapplication.app.R
import com.natashasapplication.app.appcomponents.di.MyApp
import kotlin.String

data class Iphone14SeventyeightModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup837: String? = MyApp.getInstance().resources.getString(R.string.lbl_customize)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup836: String? = MyApp.getInstance().resources.getString(R.string.lbl_customize)
  ,
  /**
   * TODO Replace with dynamic value
   */
