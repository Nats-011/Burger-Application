package com.natashasapplication.app.modules.iphone14fortyseven.`data`.model

import com.natashasapplication.app.R
import com.natashasapplication.app.appcomponents.di.MyApp
import kotlin.String

data class Iphone14FortysevenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguageThree: String? = MyApp.getInstance().resources.getString(R.string.lbl_calories_150)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtLanguageFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_sugar_10g)
  ,
  /**
   * TODO Replace with dynamic value
   */
  ...
  var txtLanguageFive: String? =
      MyApp.getInstance().resources.getString(R.string.msg_raspberry_milks)
  ,
  /**
   * TODO Replace with dynamic value
   */
